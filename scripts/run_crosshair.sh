...
#SBATCH --output=/storage/athene/work/sakharova/run_crosshair.output
#SBATCH --error=/storage/athene/work/sakharova/run_crosshair.error
echo "Starting job"
python create_preference_dataset/run_crosshair.py 