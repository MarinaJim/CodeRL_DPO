...
#SBATCH --output=/storage/athene/work/sakharova/cofmi.output
#SBATCH --error=/storage/athene/work/sakharova/cofmi.error

python create_preference_dataset/create_outputs_for_monkeytype_inputs.py