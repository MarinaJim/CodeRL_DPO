...
#SBATCH --output=/storage/athene/work/sakharova/create_monkeytype_dataset.output
#SBATCH --error=/storage/athene/work/sakharova/create_monkeytype_dataset.error

preference_dir=data/APPS/preference
